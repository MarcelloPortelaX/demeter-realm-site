(() => {
  ...
  function generateTree() {
    ...
    const ROOT_DEFS = isMobileInit ? [
      {p: [[645, 1700], [600, 1850], [520, 2000], [460, 2250]], s: 0.0, e: 0.35, prod: 0},
      {p: [[706, 1700], [706, 1900], [715, 2100], [720, 2250]], s: 0.0, e: 0.35, prod: 1},
      {p: [[767, 1700], [800, 1850], [890, 2000], [980, 2250]], s: 0.0, e: 0.35, prod: 2},
      {p: [[670, 1700], [640, 1850], [570, 2050]], s: 0.0, e: 0.35},
      {p: [[740, 1700], [770, 1850], [850, 2050]], s: 0.0, e: 0.35},
      {p: [[620, 1700], [560, 1900], [500, 2100]], s: 0.05, e: 0.4},
      {p: [[790, 1700], [840, 1900], [920, 2100]], s: 0.05, e: 0.4}
    ] : [
    ...
    const aboutBranches = isMobileInit ? [
      { id: 'about-right', p: [[710, 1100], [770, 1080], [850, 1050], [920, 1020]], s: 0.20, e: 0.35, dir: 1 },
      { id: 'about-left', p: [[725, 950], [670, 930], [590, 900], [520, 850]], s: 0.25, e: 0.40, dir: -1 }
    ] : [
