(() => {
  ...
  function generateTree() {
    ...
    const ROOT_DEFS = [
      {p: [[645, 1700], [580, 1850], [480, 2000], [isMobileInit ? 455 : 420, 2250]], s: 0.0, e: 0.35, prod: 0},
      {p: [[706, 1700], [706, 1900], [715, 2100], [720, 2250]], s: 0.0, e: 0.35, prod: 1},
      {p: [[767, 1700], [830, 1850], [950, 2000], [isMobileInit ? 985 : 1020, 2250]], s: 0.0, e: 0.35, prod: 2},
    ...
    const PRODUCTS = [
      {id: 0, x: isMobileInit ? 455 : 420, y: 2250},
      {id: 1, x: 720, y: 2250},
      {id: 2, x: isMobileInit ? 985 : 1020, y: 2250},
    ];
